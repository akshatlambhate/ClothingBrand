          ...
          formData.append("sizes",JSON.stringify(sizes));
           ...
           image4 && formData.append("image4",image4)
            ...
            if (response.data.success){
              ...
              toast.error(response.data.messatge)
            }
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3" action="">
      ...
      <div className="w-full">
        <p className="mb2">Product Name</p>
        <input
      ...
      <div className="w-full">
        <p className="mb2">Product description</p>
        <textarea
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-8">
        ...
        value={price} className="w-full px-3 py-2 sm:w-[120px]" type="number" placeholder="100" />
           </div>
      </div>
     <div>
      <p className="mb-2">
